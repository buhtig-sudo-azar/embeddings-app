    ...
    >
      <Card
        className={cn(
          ...
          accent.border,
          completed ? "ring-2 ring-offset-2 ring-emerald-300 dark:ring-emerald-700 dark:ring-offset-background" : ""
        )}
      >
            ...
            <Button
              ...
              className={cn(
                ...
                completed
                  ...
                  : "hover:bg-emerald-50 hover:text-emerald-700 hover:border-emerald-300 dark:hover:bg-emerald-950/50 dark:hover:text-emerald-300 dark:hover:border-emerald-800"
              )}
            >
              {completed ? (
                <>
