 ...
 * Цвет — изумрудный (соответствует теме эмбеддингов/attention).
 */
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-emerald-400/50",
        visible
    ...
    >
      <span
        aria-hidden
        className="absolute inset-0 rounded-full bg-emerald-500/30 animate-brain-pulse-ring"
      />
      <span
        aria-hidden
        className="absolute inset-1 rounded-full bg-emerald-500/20 animate-brain-pulse-ring-delayed"
      />
      <span
        aria-hidden
        className="absolute inset-2 rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 shadow-lg shadow-emerald-500/40 animate-brain-pulse-core"
      />
